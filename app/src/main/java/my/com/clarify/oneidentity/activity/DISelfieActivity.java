...
public class DISelfieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_di_selfie);
        ...
        imageClear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(DISelfieActivity.this);
        ...
        imageProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DISelfieActivity.this, CameraActivity.class);
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DISelfieActivity.this, DIIdentityDocumentActivity.class);
    ...
    {
        super.onBackPressed();
        Intent intent = new Intent(DISelfieActivity.this, WelcomeActivity.class);
        startActivity(intent);
        finish();
    ...
    {
        SharedPreferences preferences = getSharedPreferences(AppDelegate.SharedPreferencesTag, Context.MODE_PRIVATE);
        if(preferences.getString(getString(R.string.param_di_selfie), "").equals("")) {
            Glide.with(DISelfieActivity.this).load(R.drawable.default_user).apply(RequestOptions.circleCropTransform()).into(imageProfile);
            buttonNext.setVisibility(View.GONE);
            imageClear.setVisibility(View.INVISIBLE);
        }
        else
        {
            File f = new File(Environment.getExternalStorageDirectory().toString() + AppDelegate.appPath + "/" + preferences.getString(getString(R.string.param_di_selfie), ""));
            Glide.with(DISelfieActivity.this).load(f).apply(RequestOptions.circleCropTransform()).into(imageProfile);
        ...
        AsynRestClient.genericPost(this, AsynRestClient.viewUploadUrl, jsonObject.toString(), new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    try {
                        String newName = AppDelegate.fileNameGenerator(DISelfieActivity.this);
                        ...
                        SharedPreferences preferences = getSharedPreferences(AppDelegate.SharedPreferencesTag, Context.MODE_PRIVATE);
                        final SharedPreferences.Editor editor = preferences.edit();
                        editor.putString(getString(R.string.param_di_selfie), newName + ".jpg");
                        editor.apply();
                        triggerButtonNext();
                    }
                    catch (Exception e)
