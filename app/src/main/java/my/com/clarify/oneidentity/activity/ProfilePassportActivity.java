...
public class ProfilePassportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_passport);
        ...
        imageUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!preferences.getBoolean(getString(R.string.param_identity_credential_status), false)) {
                    inputPassportNo.setError(null);
                    if(inputPassportNo.getText().toString().equals(""))
                        inputPassportNo.setError(getString(R.string.error_required_field));
                    else {
                        ImagePicker.with(ProfilePassportActivity.this)
        ...
        imageSave = (AppCompatImageView)findViewById(R.id.image_save);
            ...
            public void onClick(View v) {
                ...
                if(inputPassportNo.getText().toString().equals(""))
                    ...
                    else
                    {
                        ...
                        editor.putString(getResources().getString(R.string.param_passport_no), inputPassportNo.getText().toString());
                        editor.apply();
                        finish();
                    }
                }
        ...
        AsynRestClient.genericPost(this, AsynRestClient.viewUploadUrl, jsonObject.toString(), new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    Glide.with(ProfilePassportActivity.this)
                            .load(imageByteArray)
                            .into(imageUpload);
                }
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response)
            {
                ...
                try {
                    ...
                    if (status.equals("200"))
                    {
                        ...
                        SharedPreferences preferences = getSharedPreferences(AppDelegate.SharedPreferencesTag, Context.MODE_PRIVATE);
                        final SharedPreferences.Editor editor = preferences.edit();
                        editor.putString(getResources().getString(R.string.param_passport), fileName);
                        editor.putString(getResources().getString(R.string.param_passport_no), inputPassportNo.getText().toString());
                        editor.apply();
                        finish();
                    }
